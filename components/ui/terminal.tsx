...
export function Terminal() {
  ...
  const commands = {
    ...
    about: () => [
      ...
      "Recent graduate from University of Mumbai (2025)",
      "Passionate about building scalable applications and backend solutions",
    ...
    future: () => [
      ...
      "   • Build applications with 10,000+ active users",
